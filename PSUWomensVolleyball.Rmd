...
ggplot(psuOffensiveRoster) + #Plot based on the PSU offensive roster
  ...
  labs(
    ...
    subtitle = "2023 Penn State Womens Volleyball season" #Addition of a subtitle 
  ) +
  theme_minimal() +
  theme(
