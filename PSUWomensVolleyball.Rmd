...
The following document aims to provide details on Penn State Women's Volleyball data. Each variable is based on specific player.

The following column headings were collected from the Penn State Women's Volleyball website and may be used in the data frames, tables, and visualizations.
